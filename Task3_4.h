...
bool Board::check_bottom_row(){
    for (int i= 0; i < size; i++){
        if (table[0][i] == 1) {
            int holder = i;
            for (int j = 1; j < size; j++){
                if (check_adjacent(j,holder - 1) == true){
                    P_win_counter++;
                }
                else if (check_adjacent(j, holder) == true)
                {
                    P_win_counter++;
            
                }
                else if (check_adjacent(j,holder + 1)== true){
                    P_win_counter++;
